...
module.exports = function (element, utils, _) {
    var copyTo, copyFrom, attrs, videojsOptions = {
            controls: false,
            preload: 'metadata',
    ...
    if (elementOptions.panorama === true) {
        ...
        copyTo = utils.compilerSettings.copy().path + '/assets/360-video-wrapper.html';
        copyFrom = utils.compilerSettings.copy().path + '/plugins/ad-video/360-video-wrapper.html';
